...
def main():
    ...
    parser.add_argument("--mmc2", type=Path, default=None, help="Path to 1-s2.0-S2589004223028249-mmc2.xlsx")
    parser.add_argument("--mmc3", type=Path, default=None, help="Path to 1-s2.0-S2589004223028249-mmc3.xlsx")
    parser.add_argument("--mmc4", type=Path, default=None, help="Path to 1-s2.0-S2589004223028249-mmc4.xlsx")
    ...
    mmc2 = args.mmc2 or find_one("*mmc2.xlsx", args.root)
    mmc3 = args.mmc3 or find_one("*mmc3.xlsx", args.root)
    mmc4 = args.mmc4 or find_one("*mmc4.xlsx", args.root)
